			...
			<div class="col-md-12">
				...
				<div class="card form" id="form1">
					...
					<br>
						...
						<hr>
						<form action="ScheduleMgrServlet" method="post">
						<div class="form-group row">
							...
							<div class="col-9" style="flex-basis:20%">
								<input class="form-control" type="text" placeholder="课程编号"
									id="TeachTaskID" style="width: 100%" name="TeachTaskID">
							</div>
							<label for="example-text-input"
								style="width: 85px;margin-left: 5%" class=" col-form-label">教室类型</label>
							<div class="col-9" style="flex-basis:20%">
								<select class="form-control" name="ClassRoomCategory"
							...
							<div class="col-9" style="flex-basis:20%">
								<select class="form-control"
									style="width: 100%;margin-top: 15px" name="Classfestival">
							...
							<div class="col-9" style="flex-basis:20%">
								<select class="form-control"
									style="width: 100%;margin-top: 15px" name="ClassTime">
