				...
				<div class="card form" id="form1">
					...
					<form action="CourseScheduleMgrServlet" method="post">
						<div class="form-group row">
							...
							<label for="example-text-input"
								style="width: 85px;margin-left: 5%;margin-top: 15px"
								class=" col-form-label" onclick="conf()">成绩备注</label>
							<div class="col-9" style="flex-basis:20%">
								<input class="form-control" type="text" placeholder="成绩备注"
									id="example-text-input" style="width: 100%;margin-top: 15px"
									name="Remark">
							</div>
						</div>
						<div style="margin-left: 40%">
							<input class="form-control" type="hidden" style="width: 100%;"
								name="CourseScheduleID"> <input class="form-control"
								type="hidden" style="width: 100%;" name="judge" value="up">
