	...
	$
			.ajax({
				...
				success : function(data) {
					topImg.html("");
					var Thtml = "";
					Thtml += "<li class='clone' aria-hidden='true' style='width: 640px; float: left; display: block;'>" 
					Thtml += "<img style='width: 640px;height: 300px;' src='admin/topImg/"+data[2].photo+"'>"
					Thtml += "<div class='pet_slider_font'>"
					Thtml += "<span>"+data[2].remark
					Thtml += "</span></div>"
					for (var i = 0; i < data.length; i++) {
						Thtml += "<li style='width: 640px; float: left; display: block;'>" 
						Thtml +="<img style='width: 640px;height: 300px;' src='admin/topImg/"+data[i].photo+"'>"
						Thtml += "<div class='pet_slider_font'>"
						Thtml += "<span>"+data[i].remark
						Thtml += "</span></div>"
						Thtml += "<div class='pet_slider_shadow'></div></li>"
					}
					Thtml += "<li class='clone' aria-hidden='true' style='width: 640px; float: left; display: block;'>" ;
					Thtml += "<img style='width: 640px;height: 300px;' src='admin/topImg/"+data[0].photo+"'>"
					Thtml += "<div class='pet_slider_font'>"
					Thtml += "<span>"+data[0].remark
					Thtml += "</span></div>"
					Thtml += "<div class='pet_slider_shadow'></div></li>"
					topImg.append(Thtml);
				},
