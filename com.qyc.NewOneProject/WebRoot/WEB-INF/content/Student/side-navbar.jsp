		...
		<div class="container-fluid ">
			...
			<ul
				...
				<li class="nav-item d-flex align-items-center"><a
					class="nav-link" href="Exit/StudentExit">注销</a></li>
			</ul>
		</div>
	</nav>
</header>
	...
	<nav class="side-navbar">
		...
		<li><a href="#Release" aria-expanded="false"
				...
				<ul id="Release" class="collapse list-unstyled">
					<li><a href="Student/StudentReleaseInfo">系统公告</a></li>
				</ul></li>
			<li><a href="#forms" aria-expanded="false"
				data-toggle="collapse"> <i class="fa fa-building-o"></i>课程管理
			</a>
				<ul id="forms" class="collapse list-unstyled">
					<li><a href="Student/TimeTables">课程表</a></li>
					<li><a href="Student/CourseSchedule">课程选择</a></li>
					<li><a href="Student/OptCourseSchedule">已选课程</a></li>
					<li><a href="Student/StudentSuccess">成绩查询</a></li>
				</ul></li>
			<li><a href="#Chart" aria-expanded="false"
				...
				<ul id="Chart" class="collapse list-unstyled">
					<li><a href="Student/StudentRevise">账号信息修改</a></li>
					<li><a href="Student/StudentRevisePwd">账号密码修改</a></li>
				</ul></li>
		</ul>
	</nav>