		...
		<div class="container-fluid ">
			...
			<ul
				...
				<li class="nav-item d-flex align-items-center"><a
					class="nav-link" href="Exit/TeacherExit">注销</a></li>
			</ul>
		</div>
	</nav>
</header>
		...
		<ul class="list-unstyled">
			<li><a href="#Release" aria-expanded="false"
				...
				<ul id="Release" class="collapse list-unstyled">
					<li><a href="Teacher/TeacherReleaseInfo">系统公告</a></li>
				</ul></li>
			<li><a href="#Chart" aria-expanded="false"
				...
				<ul id="Chart" class="collapse list-unstyled">
					<li><a href="Teacher/TimeTables">课程表</a></li>
					<li><a href="Teacher/TCourse">课程发布</a></li>
					<li><a href="Teacher/Arrange">课表配置</a></li>
					<li><a href="Teacher/VCourse">开课查询</a></li>
					<li><a href="Teacher/Success">成绩录入</a></li>
				</ul></li>
			<li><a href="#forms" aria-expanded="false"
				data-toggle="collapse"> <i class="fa fa-building-o"></i>账号信息修改
			</a>
				<ul id="forms" class="collapse list-unstyled">
					<li><a href="Teacher/TeacherRevise">账号信息修改</a></li>
					<li><a href="Teacher/TeacherRevisePwd">账号密码修改</a></li>
