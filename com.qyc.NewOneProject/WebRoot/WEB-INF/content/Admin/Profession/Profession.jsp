...
<script src="admin/js/Profession.js"></script>
<body>
	<%
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="card form" id="form1">
					...
					<br>
					<form action="Profession/insert" method="post" name="forms">
						<div class="form-group row">
							...
							<div class="col-9" style="flex-basis:20%">
								<select class="form-control" id="DepartmentID"
									name="department.DepartmentID" onchange="table()">

								</select>
							</div>
							<label for="example-text-input"
								style="width: 85px;margin-left: 5%;" class=" col-form-label">专业编号</label>
							<div class="col-9" style="flex-basis:20%">
								<input class="form-control" type="text" placeholder="专业编号"
							...
							<div class="col-9" style="flex-basis:20%">
								<input class="form-control" type="text" placeholder="专业名称"
							...
							<label for="example-search-input"
								style="width: 85px;margin-left: 5%;margin-top: 15px"
								class=" col-form-label">专业备注</label>
							<div class="col-9" style="flex-basis:30%">
								<input class="form-control" type="search" placeholder="专业备注"
						...
						<div class="page-content d-flex align-items-stretch">
							<div class="content-inner chart-cont">
								...
								<!--***** CONTENT *****-->
								<div class="row">
									<table class="table table-hover" id="Profession">
										<thead>
